    ...
    #print('acc',epoch_acc / len(train_loader))
            ...
            if global_step % eval_every == 0:
                ...
                if best_valid_loss > average_valid_loss:
                    ...
                    save_checkpoint(file_path + '/' + 'model_b_lstm.pt', model, best_valid_loss)
                    save_metrics(file_path + '/' + 'metrics_b_lstm.pt', train_loss_list, valid_loss_list, global_steps_list)
...
load_checkpoint(file_path + '/model_b_lstm.pt', best_model)
